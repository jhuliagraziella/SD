...
//                 int op2, id, cor, va, vb, bid, tipo, resp;
//                 double peso;
//                 String descricao;
...
//                         System.out.print("Digite 1 se o vertice for filme ou 0 se for pessoa: "); tipo = sc.nextInt();
//                         System.out.print("Digite a descricao do novo vertice: "); sc.nextLine(); descricao = sc.nextLine();

//                         resp = client.addVertice(id, cor, peso, descricao, tipo, true);
//                         if(resp == 2 || resp == -1)
