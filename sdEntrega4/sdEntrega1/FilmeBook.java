...
public class FilmeBook {
    public static void imprimeMenu(){
        System.out.println("\n\n ----------------------------------------------------------");
        System.out.println("| Bem vindo ao FilmeBook!! :D                              |");
        System.out.println(" ----------------------------------------------------------");
        ...
        try {
            ...
            do {
                ...
                switch(op){
                    ...
                    // case ?: // remover filme
                    //     System.out.print("Digite o IMDB ID do filme que deseja remover: "); id = sc.nextLong();
                    ...
                    //     System.out.print("Digite o CPF do cliente que deseja remover: "); id = sc.nextLong();
                    ...
                    case 5: // listar filmes assistidos por um cliente
                        System.out.print("Digite o CPF do cliente que deseja consultar: "); id = sc.nextLong();
                    ...
                    case 6: // listar filmes assistidos por um grupo de clientes
                        System.out.print("Digite a quantidade de clientes do grupo: "); tam = sc.nextInt();

                        ids.clear();
                        for(int i=1;i<=tam;i++){
                            System.out.print("Digite o CPF do cliente " + i + " do grupo: "); id = sc.nextLong();
                            ids.add(id);
                        }
                    ...
                    case 7: // consultar avaliacao media de um filme
                        System.out.print("Digite o IMDB ID do filme que deseja consultar: "); id = sc.nextLong();
                        System.out.println("Solicitacao realizada em conjunto com outros servidores.");
