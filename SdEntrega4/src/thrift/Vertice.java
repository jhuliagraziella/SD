...
public class Vertice implements org.apache.thrift.TBase<Vertice, Vertice._Fields>, java.io.Serializable, Cloneable, Comparable<Vertice> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("thrift.Vertice");
  ...
  // public boolean equals(thrift.Vertice that) {
  //   if (that == null)
  //     return false;
  //   if (this == that)
  //     return true;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("thrift.Vertice(");
    boolean first = true;
